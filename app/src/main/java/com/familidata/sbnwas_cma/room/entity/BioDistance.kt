...
@Entity(tableName = "TCMA_BIO_DISTANCE", primaryKeys = ["GET_TIME", "DEVICE_ID", "USER_ID"])
data class BioDistance(
    ...
    @ColumnInfo(name = "DISTANCE_METER") var DISTANCE_METER: String,
