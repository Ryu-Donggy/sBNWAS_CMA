...
@Entity(tableName = "TCMA_BIO_ACTIVITY", primaryKeys = ["GET_TIME", "DEVICE_ID", "USER_ID"])
data class BioActivity(
    ...
    @ColumnInfo(name = "PERIOD_MINUTE") var PERIOD_MINUTE: String?,
    @ColumnInfo(name = "TYPE") var TYPE: String?,
    @ColumnInfo(name = "TYPE_TEXT") var TYPE_TEXT: String?,
