...
class DeviceMonitorBodyFragment : PFragment() {

    private lateinit var binding: FragmentDeviceMonitorBodyBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_device_monitor_body, container, false)
    ...
    internal inner class ListAdapter(val context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
            return when (viewType) {
                PBean.TYPE_TITLE -> {
                    ...
                    val binding = ItemDeviceMonitorBinding.inflate(LayoutInflater.from(viewGroup.context), viewGroup, false)
        ...
        private fun onDataItemViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
            ...
            if (list.isEmpty()) return
            viewHolder.bind(list[position] as VoDeviceMonitor)
        }
        ...
        internal inner class DataViewHolder internal constructor(binder: ItemDeviceMonitorBinding) : RecyclerView.ViewHolder(binder.root) {
            private val ibinding: ItemDeviceMonitorBinding = binder
            internal fun bind(vo: VoDeviceMonitor) {
                ibinding.controller = controller
                ibinding.bean = vo
            }
        }
    ...
    companion object {
        fun with(controller: IController, model: PViewModel?): DeviceMonitorBodyFragment {
            val frag = DeviceMonitorBodyFragment()
