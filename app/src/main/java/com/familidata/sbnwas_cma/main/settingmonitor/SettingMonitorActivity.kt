...
class SettingMonitorActivity : BaseActivity() {
    companion object {
        fun launch(pAct: Activity) {
            val intent = Intent(pAct, SettingMonitorActivity::class.java)
    ...
    private val mBioCommonTopController: BioCommonTopController by lazy { BioCommonTopController(this, getString(R.string.setting_monitor)) }
    private val bodyController: SettingMonitorBodyController by lazy { SettingMonitorBodyController(this) }
