...
package com.familidata.base.encryption;
...
public class Aria {
    ...
    public static Aria withFirst() {
        if (ARIA == null) ARIA = new Aria("QWERTY");
        return ARIA;
    }

    public static Aria with() {
        if (ARIA == null) ARIA = new Aria(DBManager.Companion.withDB().withProperty().getProperty(PropertyObj.ENCRYPTION_CODE));
        return ARIA;
    }
}